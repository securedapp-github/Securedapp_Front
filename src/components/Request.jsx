  ...
  return (
    <div className="bg-[#0c4126] bg-opacity-50 flex lg:flex-row flex-col  ">
      <div className="md:mx-[100px] mx-[50px] md:my-[50px] mt-[50px] mb-[0px]">
        ...
        SecureDApp: Your Go-To for Comprehensive Blockchain Security & Smart Contract Audits.
        </div>
      </div>
      <div className="flex justify-center items-center md:mb-0 mb-[50px]">
        <button className=" lg:mt-[20px] md:mb-[20px] md:mt-[5px] mt-[25px] rounded-full py-2 px-8 border border-transparent text-black bg-gradient-to-r from-green-300 via-green-300 to-cyan-600 text-center font-sans md:text-2xl text-xl font-normal leading-normal">
