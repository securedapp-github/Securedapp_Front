...
const SmartContractWorkflow = () => {
  return (
    <div className="smartdevwork pb-[20px]">
      <div className="lg:mx-[180px] mx-[30px] lg:pt-[120px] pt-[10px] h-screen">
        <h1 className="font-sans lg:text-[60px] text-[20px] font-bold leading-[110%]  bg-custom-gradient bg-clip-text text-transparent lg:w-[450px]">
          How does a smart contract work?
        </h1>

        <div className="lg:pt-[400px] pt-[180px]">
          <p className="text-white font-sans text-opacity-80 lg:text-[16px] text-xs font-normal leading-[160%]">
          ...
          <br />
          <p className="text-white font-sans text-opacity-80 text-[16px] md:block hidden font-normal leading-[160%] mb-[50px]">
